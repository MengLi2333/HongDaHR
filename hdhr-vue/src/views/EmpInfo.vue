<template>
  <div>
    <el-dialog
      ...
      width="60%"
    >
      <el-form ref="CheckForm" id="CheckForm" :label-position="CheckForm.labelPosition" :model="CheckForm"
    ...
    <div  style="text-align:center;width: 100%">
      <el-input v-model="CheckForm.NameKey" placeholder="请输入关键字" prefix-icon="el-icon-search"></el-input>
    </div>
